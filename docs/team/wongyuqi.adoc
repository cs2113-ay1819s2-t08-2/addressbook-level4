...
We created 4 features, in hopes of building an application which focuses on enabling the user to develop holistically.

== My role

For this project, I worked with 3 of my team-mates, to generate ideas and brainstorm to find the more convenient yet impactful design for our project.
 +

In the technical aspect, my role was to design and write code for the Habit feature.
